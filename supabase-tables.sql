...
CREATE INDEX idx_grid_created_block_number ON grid_created(block_number DESC);
CREATE INDEX idx_grid_created_price_range ON grid_created(price_min, price_max);
CREATE INDEX idx_grid_created_composite ON grid_created(grid_id, timeperiod_id, timestamp DESC);
...
CREATE INDEX idx_bet_session_grid ON bet_placed_with_session(grid_id);
