...
- id: ${NETWORK_ID}
  ...
  - name: ChronoGrid
    ...
    - event: BetPlaced(address indexed user, bytes32 indexed gridId, uint256 timeperiodId, uint256 amountPaid, uint256 sharesReceived, uint256 pricePerShare, uint256 bAtEntry, uint256 totalshare, uint256 price_min, uint256 price_max)
    - event: GlobalLiquidityAdded(uint256 amount, uint256 newTotal)
    - event: GlobalLiquidityUpdated(uint256 newTotal)
  ...
  - name: ChronoGridWrapper
    ...
    - event: FinalBalance(address indexed user, uint256 newBalance)
    - event: RelayerUpdated(address indexed oldRelayer, address indexed newRelayer)
    - event: UpdatedPnl(address indexed user, int256 pnl)
